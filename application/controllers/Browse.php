...
class Browse extends CI_Controller {
	...
	function movie($genre_id = '', $offset = '')
	{
		...
		$page_data['page_title']	=	'Peliculas';
	...
	function playseries($series_id = '', $season_id = '')
	{
		...
		$page_data['page_title']	=	'Ver Serie';
		$page_data['series_id']		=	$series_id;
		$this->load->view('frontend/index', $page_data);
	}
	...
	function youraccount()
	{
		...
		$page_data['page_title']	=	'Su cuenta';
		$this->load->view('frontend/index', $page_data);
	}
	...
	function switchprofile()
	{
		...
		$page_data['page_title']		=	'Cambiar perfil';
	...
	function manageprofile()
	{
		...
		$page_data['page_title']		=	'Administar perfiles';
		$page_data['current_plan_id']	=	$this->crud_model->get_current_plan_id();
		$this->load->view('frontend/index', $page_data);
	...
	function emailchange()
	{
		...
		$page_data['page_title']		=	'Cambiar e-mail';
		$this->load->view('frontend/index', $page_data);
	...
	function passwordchange()
	{
		...
		$page_data['page_title']		=	'Cambiar Password';
		$this->load->view('frontend/index', $page_data);
	...
	function cancelplan()
	{
		...
		$page_data['page_title']		=	'Cancelar Plan';
		$this->load->view('frontend/index', $page_data);
