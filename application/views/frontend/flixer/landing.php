...
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/home_top_banner.jpg';?>)">
	...
	<div style="float: left;">
		...
		<!-- nombre de la app -->
		<a href="<?php echo base_url();?> assets/global/_Bienvenido_MOVIEFLIX_11163072.apk" class="btn btn-lg" >UNIRMEAHORA</a> 
		
		
		<a href="<?php echo base_url();?>assets/global/_Bienvenido_MOVIEFLIX_11163072.apk" class="btn btn-success btn-lg" style="color: white;"> <img style=" height: 50px;margin-right: 15px;" src="<?php echo base_url();?>/assets/global/icono1.png">Descarga App ANDROID </a>
	</div>
