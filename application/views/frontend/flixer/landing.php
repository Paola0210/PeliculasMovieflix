...
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/home_top_banner.jpg';?>)">
	...
	<div style="border-color: #4000FF;margin-left: 40px;">	<a target="_blank" href="<?php echo base_url();?>assets/global/_Bienvenido_MOVIEFLIX_11163072.apk" class="btn btn-danger2 btn-sm2" style="color: fff; "> <img style=" height: 50px;margin-right: 15px;" src="<?php echo base_url();?>/assets/global/icono1.png"><strong>Descarga App</strong></a></div>
	</div>
