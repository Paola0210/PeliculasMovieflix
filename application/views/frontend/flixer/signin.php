		...
		<div class="col-lg-4 col-lg-offset-4" style="clear: both;">
			<div style="background-color: #f3f3f3; padding: 30px;">
				...
				<div class="alert alert-dismissible alert-danger">
					...
					Login fallo! Porfavor intentelo nuevamente.
				</div>
				<?php endif;?>
				<form method="post" action="<?php echo base_url();?>index.php?home/signin">
					<h3 class="black_text">Iniciar</h3>
					...
					<button class="btn btn-danger" style=" width: 100%; margin: 20px 0px;"> Entrar </button>
				</form>
				<hr>
				<a href="<?php echo base_url();?>index.php?home/forget">Perdi mi Contraseña</a>
				|
